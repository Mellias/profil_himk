...
<head>
    ...
    <title>Masalah Hutan Lindung, Menyelimuti Kehidupan Masyarakat Kelurahan Gading Sari, Tanjung Sesup</title>
...
<body>
    ...
    <main>
        <div id="content">
            <h1>Masalah Hutan Lindung, Menyelimuti Kehidupan Masyarakat Kelurahan Gading Sari, Tanjung Sesup</h1>
            <img src="images/artikel9.png" alt="Himpunan Mahasiswa Kundur" class="featured-image">
            ...
            <h2>Usaha Masyarakat dan Tokoh Masyarakat</h2>
            <p>
            ...
            <h2>Pengaruh Terhadap Kehidupan Masyarakat</h2>
            <p>
            ...
            <p><strong>Penulis: Delvin Kurnia Sandi</strong></p>
        </div>
    </main>
    ...
    <footer>
        ...
        <p>&copy; <?php echo date("Y"); ?>, HIMK Tanjungpinang-Bintan</p>
    </footer> 
</body>
</html>
