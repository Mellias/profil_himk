...
<head>
    ...
    <title>Kekerasan Seksual Merajalela Hingga Menggempar ke Seluruh Indonesia</title>
...
<body>
    ...
    <main>
        <div id="content">
            <h1>Kekerasan Seksual Merajalela Hingga Menggempar ke Seluruh Indonesia</h1>
            <img src="images/opini9.png" alt="Mahasiswa HIMK" class="featured-image">
            <p>
            ...
            <p>
                ...
                <ul>
                    <li><strong>Faktor individu:</strong> Pendidikan rendah, kurangnya pengetahuan dan keterampilan menghindar dari kekerasan seksual, kontrol perilaku buruk, riwayat kekerasan, menyaksikan kekerasan seksual, dan penggunaan obat-obatan.</li>
                    <li><strong>Faktor lingkungan sosial:</strong> Kebudayaan atau kebiasaan yang mendukung kekerasan seksual, kekerasan yang dilihat melalui media, kelemahan kesehatan, pendidikan, ekonomi, dan hukum, serta aturan yang tidak sesuai atau berbahaya.</li>
                    <li><strong>Faktor hubungan:</strong> Kelemahan hubungan antara anak dan orangtua, konflik dalam keluarga, berhubungan dengan pelaku kekerasan, dan tergabung dalam geng atau komplotan.</li>
                </ul>
            </p>
            <p>
            ...
            <p>
                <strong>Penulis: Atika Malasari</strong>
            </p>
        </div>
    </main>
