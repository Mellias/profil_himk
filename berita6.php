<?php
// Header dan fungsi lain bisa diletakkan di sini jika perlu
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Riuh Bercampur Bahagia, Himpunan Mahasiswa Kundur Menggelar Sembang Alumni</title>
...
<body>
    ...
    <main>
        <div id="content">
            <h1>Riuh Bercampur Bahagia, Himpunan Mahasiswa Kundur Menggelar Sembang Alumni</h1>
            <img src="images/berita6.png" alt="Kunjungan Kasih" class="featured-image" />
            <p>
            ...
            <p class="author"><strong>Penulis: Manja Nurani</strong></p>
        </div>
    </main>
