...
<head>
    ...
    <title>Berjalan Dengan Antusias, HIMK Mengadakan Sosialisasi Ke Sebelas</title>
...
<body>
    ...
    <main>
        <div id="content">
            <h1>Berjalan Dengan Antusias, HIMK Mengadakan Sosialisasi Ke Sebelas</h1>
            <img src="images/berita3.png" alt="Sosialisasi HIMK 2023" class="featured-image" />

            <section>
                <h2>Pengenalan Kegiatan</h2>
                <p>
                    <strong>Kundur</strong> - Himpunan Mahasiswa Kundur (HIMK) Tanjungpinang-Bintan telah melaksanakan kegiatan Sosialisasi perguruan tinggi negeri, perguruan tinggi swasta, jalur masuk, dan beasiswa yang ada di Tanjungpinang dan Bintan. Pada tahun 2023, kegiatan sosialisasi ini merupakan kegiatan sosialisasi ke-11 dengan tema "Menanam Niat, Menuai Hajat."
                </p>
                <p>
            ...
            <section>
                <h2>Pengalaman dari Ketua Pelaksana</h2>
                <blockquote>
            ...
            <section>
                ...
                <p><strong>Penulis: Muhammad Wibhi Kurnia</strong></p>
            </section>
        </div>
    </main>
