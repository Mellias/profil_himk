<?php 
// Bisa digunakan untuk menyisipkan logika dinamis di sini, seperti koneksi database, header dinamis, atau validasi pengguna.
// include('config.php'); // Contoh include file konfigurasi.
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Administrasi Menjadi Penghalang Terwujudnya Keinginan Masyarakat Desa Sawang Laut</title>
...
<body>
    ...
    <main>
        <div id="content">
            <h1>Administrasi Menjadi Penghalang Terwujudnya Keinginan Masyarakat Desa Sawang Laut</h1>
            <img src="images/artikel8.png" alt="Himpunan Mahasiswa Kundur" class="featured-image">

            <h2>Latihan Kepemimpinan Tingkat II</h2>
            <p>
            ...
            <h2>Pelaksanaan di Desa Sawang Laut</h2>
            <p>
            ...
            <h2>Diskusi dengan Masyarakat</h2>
            <p>
            ...
            <h2>Potensi dan Kendala Desa Sawang Laut</h2>
            <p>
            ...
            <p><strong>Penulis: Nurmalina Juwita</strong></p>
        </div>
    </main>
    ...
    <footer>
        ...
        <p>&#169; 2024, HIMK Tanjungpinang-Bintan</p>
    </footer> 
</body>
</html>
