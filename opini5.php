<?php
// file: merdeka_tapi_tanda_tanya.php
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Merdeka, Tapi Tanda Tanya</title>
...
<body>
    ...
    <main>
        <div id="content">
            <h1>Merdeka, Tapi Tanda Tanya</h1>
            <img src="images/opini5.png" alt="Okta Alamsyah" class="featured-image">
            <p>
