...
<head>
    ...
    <title><?php echo "Memperingati Hari Anak Nasional, HIMK Adakan Kunjungan Kasih"; ?></title>
...
<body>
    ...
    <main>
        <div id="content">
            <h1><?php echo "Memperingati Hari Anak Nasional, HIMK Adakan Kunjungan Kasih"; ?></h1>
            <img src="images/berita4.png" alt="Kunjungan Kasih" class="featured-image" />
            
            <section>
                <h2><?php echo "Program Kerja HIMK"; ?></h2>
                <p>
            ...
            <section>
                <h2><?php echo "Penggalangan Dana"; ?></h2>
                <p>
            ...
            <section>
                <h2><?php echo "Ucapan Terima Kasih"; ?></h2>
                <blockquote>
            ...
            <section>
                <h2><?php echo "Harapan untuk Masa Depan"; ?></h2>
                <blockquote>
            ...
            <p class="author"><strong><?php echo "Penulis: Muhammad Wibhi Kurnia"; ?></strong></p>
        </div>
    </main>
